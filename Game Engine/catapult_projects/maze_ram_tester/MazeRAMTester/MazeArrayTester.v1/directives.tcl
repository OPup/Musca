...
//  
//  Running on Windows 7 kjr115@EEWS104A-005 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {../../src/MazeArrayTester.cpp} -type C++
...
directive set -DESIGN_HIERARCHY MazeArrayTester
go compile
go extract
