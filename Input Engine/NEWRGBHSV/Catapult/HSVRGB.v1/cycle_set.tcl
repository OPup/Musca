...
directive set /HSVRGB/core/main/else#7:and CSTEPS_FROM {{.. == 3}}
...
directive set /HSVRGB/core/main/else#7:mux1h#1 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:mux1h#2 CSTEPS_FROM {{.. == 5}}
...
directive set /HSVRGB/core/main/else#7:acc CSTEPS_FROM {{.. == 5}}
directive set /HSVRGB/core/main/and#4 CSTEPS_FROM {{.. == 5}}
directive set /HSVRGB/core/main/and#1 CSTEPS_FROM {{.. == 5}}
directive set /HSVRGB/core/main/acc#2 CSTEPS_FROM {{.. == 5}}
