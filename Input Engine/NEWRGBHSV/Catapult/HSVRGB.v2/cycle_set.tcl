...
# Loop constraints
directive set /HSVRGB/core/main CSTEPS_FROM {{. == 5}}
...
directive set /HSVRGB/core/main/io_write(H_OUT:rsc.d) CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/io_write(S_OUT:rsc.d) CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/io_write(V_OUT:rsc.d) CSTEPS_FROM {{.. == 4}}
...
directive set /HSVRGB/core/main/else#7:acc#4 CSTEPS_FROM {{.. == 1}}
...
directive set /HSVRGB/core/main/else#7:and#4 CSTEPS_FROM {{.. == 3}}
directive set /HSVRGB/core/main/else#7:if#1:equal CSTEPS_FROM {{.. == 1}}
...
directive set /HSVRGB/core/main/else#7:else#1:if:equal CSTEPS_FROM {{.. == 1}}
...
directive set /HSVRGB/core/main/else#7:else#1:if:acc#1 CSTEPS_FROM {{.. == 4}}
...
directive set /HSVRGB/core/main/else#7:else#1:else:acc#1 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:else#1:mux#2 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:mux#6 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:mux1h CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:else#1:mux CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:mux#4 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:else#1:mux#1 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:mux#5 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:acc CSTEPS_FROM {{.. == 4}}
...
directive set /HSVRGB/core/main/acc#3 CSTEPS_FROM {{.. == 3}}
