...
directive set /HSVRGB/core/main/equal CSTEPS_FROM {{.. == 1}}
...
directive set /HSVRGB/core/main/else#7:acc CSTEPS_FROM {{.. == 3}}
directive set /HSVRGB/core/main/and#1 CSTEPS_FROM {{.. == 3}}
directive set /HSVRGB/core/main/and CSTEPS_FROM {{.. == 3}}
directive set /HSVRGB/core/main/mul#1 CSTEPS_FROM {{.. == 3}}
directive set /HSVRGB/core/main/acc#4 CSTEPS_FROM {{.. == 1}}
