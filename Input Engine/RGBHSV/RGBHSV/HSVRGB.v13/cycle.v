...
//  Generated date: Thu Apr 28 15:30:39 2016
// ----------------------------------------------------------------------
            ...
            default : begin
              if ( else_7_equal_svs_st_4 ) begin
                case (else_7_if_1_div_4cyc_st_4)
                  2'b0 : begin
                    h_sg1_4_sva_duc = div_mgc_div_9_z[7:0];
                  end
                  2'b1 : begin
                    h_sg1_4_sva_duc = div_mgc_div_10_z[7:0];
                  end
                  2'b10 : begin
                    h_sg1_4_sva_duc = div_mgc_div_11_z[7:0];
                  end
                  2'b11 : begin
                    h_sg1_4_sva_duc = div_mgc_div_z[7:0];
                  end
                  default : begin
                  end
                endcase
                ...
                case (else_7_else_1_if_div_4cyc_st_4)
                  2'b0 : begin
                    h_sg1_6_sva_duc = div_mgc_div_5_z[7:0];
                  end
                  2'b1 : begin
                    h_sg1_6_sva_duc = div_mgc_div_6_z[7:0];
                  end
                  2'b10 : begin
                    h_sg1_6_sva_duc = div_mgc_div_7_z[7:0];
                  end
                  2'b11 : begin
                    h_sg1_6_sva_duc = div_mgc_div_8_z[7:0];
                  end
                  default : begin
                  end
                endcase
                h_sg1_4_sva_1_sg1 = (h_sg1_6_sva_duc[7:2]) + 6'b1;
              end
              else begin
                case (else_7_else_1_else_div_4cyc_st_4)
                  2'b0 : begin
                    h_sg1_5_sva_duc = div_mgc_div_1_z[7:0];
                  end
                  2'b1 : begin
                    h_sg1_5_sva_duc = div_mgc_div_2_z[7:0];
                  end
                  2'b10 : begin
                    h_sg1_5_sva_duc = div_mgc_div_3_z[7:0];
                  end
                  2'b11 : begin
                    h_sg1_5_sva_duc = div_mgc_div_4_z[7:0];
                  end
                  default : begin
                  end
                endcase
                h_sg1_4_sva_2_sg1 = (h_sg1_5_sva_duc[7:3]) + 5'b1;
              end
              ...
              h_sg1_4_lpi_dfm_1_sg2 = MUX1HOT_v_5_3_2({h_sg1_4_sva_2_sg1 , (h_sg1_4_sva_1_sg1[5:1])
                  , (h_sg1_4_sva_duc[7:3])}, {else_7_nor_ssc , else_7_and_5_itm_4
                  , else_7_equal_svs_4});
              else_7_acc_psp_sva = readslicef_9_8_1((({(~ h_sg1_4_lpi_dfm_1_sg2)
                  , (~ h_sg1_4_lpi_dfm_1_sg1) , (~ h_sg1_4_lpi_dfm_3) , 1'b1}) +
                  ({(h_sg1_4_lpi_dfm_1_sg2[0]) , h_sg1_4_lpi_dfm_1_sg1 , h_sg1_4_lpi_dfm_3
                  , 5'b1})));
              if ( else_7_acc_psp_sva[7] ) begin
                h_sg1_1_sg2_sva_2 = ({1'b1 , (else_7_acc_psp_sva[6:2])}) + 6'b101101;
              end
            end
          endcase
          else_7_mux_7_nl = MUX_v_6_2_2({(else_7_acc_psp_sva[7:2]) , h_sg1_1_sg2_sva_2},
              else_7_acc_psp_sva[7]);
          H_OUT_rsc_mgc_out_stdreg_d <= {(signext_9_8({((else_7_mux_7_nl) & ({{5{unequal_tmp_5}},
