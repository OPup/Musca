...
directive set /HSVRGB/core/main/else#7:acc#2 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:if#2:acc CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/and#2 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/else#7:mux#7 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/and#1 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/acc#3 CSTEPS_FROM {{.. == 4}}
directive set /HSVRGB/core/main/and CSTEPS_FROM {{.. == 3}}
directive set /HSVRGB/core/main/mul#1 CSTEPS_FROM {{.. == 3}}
directive set /HSVRGB/core/main/acc#4 CSTEPS_FROM {{.. == 3}}
