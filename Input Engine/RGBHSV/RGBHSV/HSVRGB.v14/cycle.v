...
//  Generated date: Thu Apr 28 15:36:07 2016
// ----------------------------------------------------------------------
...
module HSVRGB_core (
  ...
  begin : core
    ...
    reg [8:0] h_sg1_6_sva_duc;
    reg [1:0] else_7_else_1_else_div_4cyc;
    reg [8:0] h_sg1_5_sva_duc;
    ...
    reg main_stage_0_4;
    reg main_stage_0_5;
    reg [6:0] h_sg1_4_sva_1_sg1;
    reg [5:0] h_sg1_4_sva_2_sg1;
    reg else_7_nor_ssc;
    reg [5:0] h_sg1_4_lpi_dfm_1_sg2;
    ...
    begin : mainExit
      forever begin : main
        ...
        if ( main_stage_0_5 ) begin
          ...
          h_sg1_4_sva_2_sg1 = 6'b0;
          h_sg1_4_sva_1_sg1 = 7'b0;
            ...
            default : begin
              if ( else_7_equal_svs_st_4 ) begin
                case (else_7_if_1_div_4cyc_st_4)
                  2'b0 : begin
                    h_sg1_4_sva_duc = div_mgc_div_9_z[8:0];
                  end
                  2'b1 : begin
                    h_sg1_4_sva_duc = div_mgc_div_10_z[8:0];
                  end
                  2'b10 : begin
                    h_sg1_4_sva_duc = div_mgc_div_11_z[8:0];
                  end
                  2'b11 : begin
                    h_sg1_4_sva_duc = div_mgc_div_z[8:0];
                  end
                  default : begin
                  end
                endcase
                ...
                case (else_7_else_1_if_div_4cyc_st_4)
                  2'b0 : begin
                    h_sg1_6_sva_duc = div_mgc_div_5_z[8:0];
                  end
                  2'b1 : begin
                    h_sg1_6_sva_duc = div_mgc_div_6_z[8:0];
                  end
                  2'b10 : begin
                    h_sg1_6_sva_duc = div_mgc_div_7_z[8:0];
                  end
                  2'b11 : begin
                    h_sg1_6_sva_duc = div_mgc_div_8_z[8:0];
                  end
                  default : begin
                  end
                endcase
                h_sg1_4_sva_1_sg1 = (h_sg1_6_sva_duc[8:2]) + 7'b1;
              end
              else begin
                case (else_7_else_1_else_div_4cyc_st_4)
                  2'b0 : begin
                    h_sg1_5_sva_duc = div_mgc_div_1_z[8:0];
                  end
                  2'b1 : begin
                    h_sg1_5_sva_duc = div_mgc_div_2_z[8:0];
                  end
                  2'b10 : begin
                    h_sg1_5_sva_duc = div_mgc_div_3_z[8:0];
                  end
                  2'b11 : begin
                    h_sg1_5_sva_duc = div_mgc_div_4_z[8:0];
                  end
                  default : begin
                  end
                endcase
                h_sg1_4_sva_2_sg1 = (h_sg1_5_sva_duc[8:3]) + 6'b1;
              end
              ...
              h_sg1_4_lpi_dfm_3 = MUX1HOT_v_2_3_2({(h_sg1_5_sva_duc[1:0]) , (h_sg1_6_sva_duc[1:0])
                  ...
                  , else_7_equal_svs_4});
              h_sg1_4_lpi_dfm_1_sg2 = MUX1HOT_v_6_3_2({h_sg1_4_sva_2_sg1 , (h_sg1_4_sva_1_sg1[6:1])
                  , (h_sg1_4_sva_duc[8:3])}, {else_7_nor_ssc , else_7_and_5_itm_4
                  , else_7_equal_svs_4});
              else_7_acc_psp_sva = readslicef_10_9_1((({(~ h_sg1_4_lpi_dfm_1_sg2)
                  , (~ h_sg1_4_lpi_dfm_1_sg1) , (~ h_sg1_4_lpi_dfm_3) , 1'b1}) +
                  ({(h_sg1_4_lpi_dfm_1_sg2[1:0]) , h_sg1_4_lpi_dfm_1_sg1 , h_sg1_4_lpi_dfm_3
                  , 5'b1})));
              if ( else_7_acc_psp_sva[8] ) begin
                h_sg1_1_sg2_sva_2 = ({1'b1 , (else_7_acc_psp_sva[7:2])}) + 7'b101101;
              end
            end
          endcase
    ...
    h_sg1_5_sva_duc = 9'b0;
    else_7_else_1_else_div_4cyc = 2'b0;
    h_sg1_6_sva_duc = 9'b0;
