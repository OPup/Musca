...
//  
//  Running on Windows 7 oh1015@EEWS104A-009 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./RGBHSV.cpp} -type C++
...
directive set -CLOCKS {clk {-CLOCK_PERIOD 20.0 -CLOCK_EDGE rising -CLOCK_UNCERTAINTY 0.0 -CLOCK_HIGH_TIME 10.0 -RESET_SYNC_NAME rst -RESET_ASYNC_NAME arst_n -RESET_KIND async -RESET_SYNC_ACTIVE high -RESET_ASYNC_ACTIVE low -ENABLE_NAME {} -ENABLE_ACTIVE high}}
...
go compile
directive set /HSVRGB/core -DESIGN_GOAL area
directive set /HSVRGB/core/main -PIPELINE_INIT_INTERVAL 1
directive set /RGB_HSV/core -DESIGN_GOAL latency
directive set /RGB_HSV/core/main -UNROLL no
directive set /RGB_HSV/core/main -PIPELINE_INIT_INTERVAL 1
go architect
go extract
