...
//  Generated date: Thu Apr 28 11:03:23 2016
// ----------------------------------------------------------------------
    ...
    begin : mainExit
      forever begin : main
        ...
        if ( main_stage_0_5 ) begin
          ...
          endcase
          else_7_mux_13_nl = MUX_v_7_2_2({(else_7_acc_psp_sva[7:1]) , h_sg5_3_sva_2},
              else_7_acc_psp_sva[8]);
          H_OUT_rsc_mgc_out_stdreg_d <= {((else_7_mux_13_nl) & ({{6{unequal_tmp_5}},
