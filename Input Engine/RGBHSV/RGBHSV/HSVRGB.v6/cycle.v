...
//  Generated date: Wed Apr 27 18:44:16 2016
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        if ( main_stage_0_3 ) begin
          ...
          case (delta_sva_st_2)
            ...
            default : begin
              ...
              endcase
              s_sg1_lpi_dfm = s_sg1_sva_2_duc & ({{7{unequal_tmp_5}}, unequal_tmp_5});
              if ( else_7_equal_svs_st_2 ) begin
                if ( else_7_if_1_div_2cyc_st_2 ) begin
                  ...
                  else_7_if_1_ac_fixed_cctor_sg1_1_sva_duc = div_mgc_div_5_z[8:0];
                end
              end
              else if ( else_7_else_1_equal_svs_st_2 ) begin
                if ( else_7_else_1_if_div_2cyc_st_2 ) begin
                  div_sdt_2_sva_duc = div_mgc_div_4_z[8:0];
                end
                else begin
                  div_sdt_2_sva_duc = div_mgc_div_3_z[8:0];
                end
          ...
          H_OUT_rsc_mgc_out_stdreg_d <= {((else_7_mux_14_nl) & ({{6{unequal_tmp_3}},
              unequal_tmp_3})) , ((else_7_acc_psp_sva[0]) & unequal_tmp_3) , 2'b0};
          S_OUT_rsc_mgc_out_stdreg_d <= {conv_s2u_16_8(8'b11001 * (s_sg1_lpi_dfm
              & ({{7{unequal_tmp_3}}, unequal_tmp_3}))) , 2'b0};
          V_OUT_rsc_mgc_out_stdreg_d <= {1'b0 , acc_5_itm_2};
        end
        ...
        v_sg1_sva = readslicef_14_9_5(conv_u2u_28_14(conv_u2u_10_14(max_lpi_dfm_3)
            * 14'b11001));
        ...
        delta_sva = readslicef_11_10_1((({max_lpi_dfm_3 , 1'b1}) + ({(~ (mux1h_1_nl))
            , 1'b1})));
        case (delta_sva)
          10'b0 : begin
            // NOP
          ...
          default : begin
            unequal_tmp_1 = (max_lpi_dfm_3[9]) | (max_lpi_dfm_3[8]) | (max_lpi_dfm_3[7])
                | (max_lpi_dfm_3[6]) | (max_lpi_dfm_3[5]) | (max_lpi_dfm_3[4]) |
                (max_lpi_dfm_3[3]) | (max_lpi_dfm_3[2]) | (max_lpi_dfm_3[1]) | (max_lpi_dfm_3[0]);
        ...
        unequal_tmp_2 = (delta_sva[9]) | (delta_sva[8]) | (delta_sva[7]) | (delta_sva[6])
            | (delta_sva[5]) | (delta_sva[4]) | (delta_sva[3]) | (delta_sva[2]) |
            (delta_sva[1]) | (delta_sva[0]);
        unequal_tmp_5 = unequal_tmp_4;
        unequal_tmp_4 = unequal_tmp_1;
