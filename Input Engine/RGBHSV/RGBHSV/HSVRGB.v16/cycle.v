...
//  Generated date: Thu Apr 28 16:00:19 2016
// ----------------------------------------------------------------------
...
module HSVRGB_core (
  ...
  begin : core
    ...
    reg [7:0] mut_8_sg1_1;
    reg [9:0] mut_9_sg1_1;
    reg [7:0] mut_10_sg1_1;
    reg [9:0] mut_11_sg1_1;
    reg [7:0] mut_12_sg1_1;
    reg [9:0] mut_13_sg1_1;
    reg [7:0] mut_14_sg1_1;
    reg [9:0] mut_15_sg1_1;
    reg [7:0] mut_16_sg1_1;
    ...
    begin : mainExit
      forever begin : main
        ...
        div_mgc_div_a <= 16'b0;
        div_mgc_div_b <= 16'b0;
        div_mgc_div_1_a <= 16'b0;
        div_mgc_div_1_b <= 16'b0;
        div_mgc_div_2_a <= 16'b0;
        div_mgc_div_2_b <= 16'b0;
        div_mgc_div_3_a <= 16'b0;
        div_mgc_div_3_b <= 16'b0;
        div_mgc_div_4_a <= 16'b0;
        div_mgc_div_4_b <= 16'b0;
        div_mgc_div_5_a <= 16'b0;
        div_mgc_div_5_b <= 16'b0;
        div_mgc_div_6_a <= 16'b0;
        div_mgc_div_6_b <= 16'b0;
        div_mgc_div_7_a <= 16'b0;
        div_mgc_div_7_b <= 16'b0;
        div_mgc_div_8_a <= 16'b0;
        ...
        if ( main_stage_0_4 ) begin
            ...
            default : begin
              if ( else_7_equal_svs_st_3 ) begin
                case (else_7_if_1_div_3cyc_st_3)
                  2'b0 : begin
                    h_sg1_4_sva_duc = div_mgc_div_7_z[7:0];
                  end
                  2'b1 : begin
                    h_sg1_4_sva_duc = div_mgc_div_8_z[7:0];
                  end
                  2'b10 : begin
                ...
                case (else_7_else_1_if_div_3cyc_st_3)
                  2'b0 : begin
                    h_sg1_6_sva_duc = div_mgc_div_4_z[7:0];
                  end
                  2'b1 : begin
              ...
              h_sg1_4_lpi_dfm_1_sg1 = MUX1HOT_s_1_3_2({(h_sg1_5_sva_duc[2]) , (h_sg1_4_sva_1_sg1[0])
                  , (h_sg1_4_sva_duc[2])}, {else_7_nor_ssc , else_7_and_5_itm_3 ,
                  else_7_equal_svs_3});
              h_sg1_4_lpi_dfm_3 = MUX1HOT_v_2_3_2({(h_sg1_5_sva_duc[1:0]) , (h_sg1_6_sva_duc[1:0])
                  , (h_sg1_4_sva_duc[1:0])}, {else_7_nor_ssc , else_7_and_5_itm_3
                  , else_7_equal_svs_3});
              h_sg1_4_lpi_dfm_1_sg2 = MUX1HOT_v_5_3_2({h_sg1_4_sva_2_sg1 , (h_sg1_4_sva_1_sg1[5:1])
                  , (h_sg1_4_sva_duc[7:3])}, {else_7_nor_ssc , else_7_and_5_itm_3
                  , else_7_equal_svs_3});
          ...
          H_OUT_rsc_mgc_out_stdreg_d <= {(signext_9_8({((else_7_mux_7_nl) & ({{5{unequal_tmp_4}},
              unequal_tmp_4})) , ((else_7_acc_psp_sva[1:0]) & ({{1{unequal_tmp_4}},
              unequal_tmp_4}))})) , 1'b0};
          S_OUT_rsc_mgc_out_stdreg_d <= {2'b0 , acc_4_itm_1};
          V_OUT_rsc_mgc_out_stdreg_d <= {2'b0 , acc_5_itm_3};
        end
        if ( main_stage_0_3 ) begin
          s_sg1_1_lpi_dfm = 10'b0;
              ...
              case (max_sg1_lpi_dfm_3_st_2)
                ...
                default : begin
                  if ( else_7_if_div_2cyc_st_2 ) begin
                    s_sg1_1_sva_2_duc = div_mgc_div_9_z[9:0];
                  end
                  else begin
                    s_sg1_1_sva_2_duc = div_mgc_div_10_z[9:0];
                  end
                end
              endcase
              s_sg1_1_lpi_dfm = s_sg1_1_sva_2_duc & ({{9{unequal_tmp_6}}, unequal_tmp_6});
              if ( else_7_equal_svs_st_2 ) begin
                case (else_7_if_1_div_3cyc_st_2)
                  2'b0 : begin
                    div_mgc_div_7_a <= {({{2{mut_47_sg1_1[7]}}, mut_47_sg1_1}) ,
                        6'b0};
                    div_mgc_div_7_b <= {1'b0 , mut_49_sg1_1 , 5'b0};
                  end
                  2'b1 : begin
                    div_mgc_div_8_a <= {({{2{mut_51_sg1_1[7]}}, mut_51_sg1_1}) ,
                        6'b0};
                    div_mgc_div_8_b <= {1'b0 , mut_53_sg1_1 , 5'b0};
                  end
                  2'b10 : begin
                    div_mgc_div_a <= {({{2{mut_19_sg1_1[7]}}, mut_19_sg1_1}) , 6'b0};
                    div_mgc_div_b <= {1'b0 , mut_21_sg1_1 , 5'b0};
                  end
                  default : begin
                    // NOP
                  end
                ...
                case (else_7_else_1_if_div_3cyc_st_2)
                  2'b0 : begin
                    div_mgc_div_4_a <= {({{2{mut_35_sg1_1[7]}}, mut_35_sg1_1}) ,
                        6'b0};
                    div_mgc_div_4_b <= {1'b0 , mut_37_sg1_1 , 5'b0};
                  end
                  2'b1 : begin
                    div_mgc_div_5_a <= {({{2{mut_39_sg1_1[7]}}, mut_39_sg1_1}) ,
                        6'b0};
                    div_mgc_div_5_b <= {1'b0 , mut_41_sg1_1 , 5'b0};
                  end
                  2'b10 : begin
                    div_mgc_div_6_a <= {({{2{mut_43_sg1_1[7]}}, mut_43_sg1_1}) ,
                        6'b0};
                    div_mgc_div_6_b <= {1'b0 , mut_45_sg1_1 , 5'b0};
                  end
                  default : begin
                    // NOP
                  end
                ...
                case (else_7_else_1_else_div_3cyc_st_2)
                  2'b0 : begin
                    div_mgc_div_1_a <= {({{2{mut_23_sg1_1[7]}}, mut_23_sg1_1}) ,
                        6'b0};
                    div_mgc_div_1_b <= {1'b0 , mut_25_sg1_1 , 5'b0};
                  end
                  2'b1 : begin
                    div_mgc_div_2_a <= {({{2{mut_27_sg1_1[7]}}, mut_27_sg1_1}) ,
                        6'b0};
                    div_mgc_div_2_b <= {1'b0 , mut_29_sg1_1 , 5'b0};
                  end
                  2'b10 : begin
                    div_mgc_div_3_a <= {({{2{mut_31_sg1_1[7]}}, mut_31_sg1_1}) ,
                        6'b0};
                    div_mgc_div_3_b <= {1'b0 , mut_33_sg1_1 , 5'b0};
                  end
                  default : begin
                    // NOP
                  end
          ...
          endcase
          asn_rnd_1_sg1_sva = readslicef_10_8_2(conv_u2u_20_10(10'b11001 * (s_sg1_1_lpi_dfm
            ...
            default : begin
              ...
              if ( else_7_equal_svs_st_1 ) begin
                case (else_7_if_1_div_3cyc_st_1)
                  2'b0 : begin
                    div_mgc_div_7_a <= {({{2{mut_46_sg1_1[7]}}, mut_46_sg1_1}) ,
                        6'b0};
                    div_mgc_div_7_b <= {1'b0 , mut_48_sg1_1 , 5'b0};
                  end
                  2'b1 : begin
                    div_mgc_div_8_a <= {({{2{mut_50_sg1_1[7]}}, mut_50_sg1_1}) ,
                        6'b0};
                    div_mgc_div_8_b <= {1'b0 , mut_52_sg1_1 , 5'b0};
                  end
                  2'b10 : begin
                    div_mgc_div_a <= {({{2{mut_18_sg1_1[7]}}, mut_18_sg1_1}) , 6'b0};
                    div_mgc_div_b <= {1'b0 , mut_20_sg1_1 , 5'b0};
                  end
                  default : begin
                    // NOP
                  end
                ...
                case (else_7_else_1_if_div_3cyc_st_1)
                  2'b0 : begin
                    div_mgc_div_4_a <= {({{2{mut_34_sg1_1[7]}}, mut_34_sg1_1}) ,
                        6'b0};
                    div_mgc_div_4_b <= {1'b0 , mut_36_sg1_1 , 5'b0};
                  end
                  2'b1 : begin
                    div_mgc_div_5_a <= {({{2{mut_38_sg1_1[7]}}, mut_38_sg1_1}) ,
                        6'b0};
                    div_mgc_div_5_b <= {1'b0 , mut_40_sg1_1 , 5'b0};
                  end
                  2'b10 : begin
                    div_mgc_div_6_a <= {({{2{mut_42_sg1_1[7]}}, mut_42_sg1_1}) ,
                        6'b0};
                    div_mgc_div_6_b <= {1'b0 , mut_44_sg1_1 , 5'b0};
                  end
                  default : begin
                    // NOP
                  end
                ...
                case (else_7_else_1_else_div_3cyc_st_1)
                  2'b0 : begin
                    div_mgc_div_1_a <= {({{2{mut_22_sg1_1[7]}}, mut_22_sg1_1}) ,
                        6'b0};
                    div_mgc_div_1_b <= {1'b0 , mut_24_sg1_1 , 5'b0};
                  end
                  2'b1 : begin
                    div_mgc_div_2_a <= {({{2{mut_26_sg1_1[7]}}, mut_26_sg1_1}) ,
                        6'b0};
                    div_mgc_div_2_b <= {1'b0 , mut_28_sg1_1 , 5'b0};
                  end
                  2'b10 : begin
                    div_mgc_div_3_a <= {({{2{mut_30_sg1_1[7]}}, mut_30_sg1_1}) ,
                        6'b0};
                    div_mgc_div_3_b <= {1'b0 , mut_32_sg1_1 , 5'b0};
                  end
                  default : begin
                    // NOP
                  end
          ...
          default : begin
            ...
            if ( else_7_equal_svs ) begin
              ...
              case (else_7_if_1_div_3cyc)
                2'b0 : begin
                  mut_14_sg1_1 = else_7_if_1_conc_2_tmp_sg1;
                  div_mgc_div_7_a <= {({{2{else_7_if_1_conc_2_tmp_sg1[7]}}, else_7_if_1_conc_2_tmp_sg1})
                      , 6'b0};
                  mut_15_sg1_1 = acc_2_psp_sva;
                  div_mgc_div_7_b <= {1'b0 , acc_2_psp_sva , 5'b0};
                end
                2'b1 : begin
                  mut_16_sg1_1 = else_7_if_1_conc_2_tmp_sg1;
                  div_mgc_div_8_a <= {({{2{else_7_if_1_conc_2_tmp_sg1[7]}}, else_7_if_1_conc_2_tmp_sg1})
                      , 6'b0};
                  mut_17_sg1_1 = acc_2_psp_sva;
                  div_mgc_div_8_b <= {1'b0 , acc_2_psp_sva , 5'b0};
                end
                2'b10 : begin
                  mut_sg1_1 = else_7_if_1_conc_2_tmp_sg1;
                  div_mgc_div_a <= {({{2{else_7_if_1_conc_2_tmp_sg1[7]}}, else_7_if_1_conc_2_tmp_sg1})
                      , 6'b0};
              ...
              if ( else_7_else_1_equal_svs ) begin
                ...
                case (else_7_else_1_if_div_3cyc)
                  2'b0 : begin
                    mut_8_sg1_1 = else_7_else_1_if_conc_2_tmp_sg1;
                    div_mgc_div_4_a <= {({{2{else_7_else_1_if_conc_2_tmp_sg1[7]}},
                        else_7_else_1_if_conc_2_tmp_sg1}) , 6'b0};
                    mut_9_sg1_1 = acc_2_psp_sva;
                    div_mgc_div_4_b <= {1'b0 , acc_2_psp_sva , 5'b0};
                  end
                  2'b1 : begin
                    mut_10_sg1_1 = else_7_else_1_if_conc_2_tmp_sg1;
                    div_mgc_div_5_a <= {({{2{else_7_else_1_if_conc_2_tmp_sg1[7]}},
                        else_7_else_1_if_conc_2_tmp_sg1}) , 6'b0};
                    mut_11_sg1_1 = acc_2_psp_sva;
                    div_mgc_div_5_b <= {1'b0 , acc_2_psp_sva , 5'b0};
                  end
                  2'b10 : begin
                    mut_12_sg1_1 = else_7_else_1_if_conc_2_tmp_sg1;
                    div_mgc_div_6_a <= {({{2{else_7_else_1_if_conc_2_tmp_sg1[7]}},
                        else_7_else_1_if_conc_2_tmp_sg1}) , 6'b0};
                    mut_13_sg1_1 = acc_2_psp_sva;
                ...
                case (else_7_else_1_else_div_3cyc)
                  2'b0 : begin
                    mut_2_sg1_1 = else_7_else_1_else_conc_2_tmp_sg1;
                    div_mgc_div_1_a <= {({{2{else_7_else_1_else_conc_2_tmp_sg1[7]}},
                        else_7_else_1_else_conc_2_tmp_sg1}) , 6'b0};
                    mut_3_sg1_1 = acc_2_psp_sva;
                    div_mgc_div_1_b <= {1'b0 , acc_2_psp_sva , 5'b0};
                  end
                  2'b1 : begin
                    mut_4_sg1_1 = else_7_else_1_else_conc_2_tmp_sg1;
                    div_mgc_div_2_a <= {({{2{else_7_else_1_else_conc_2_tmp_sg1[7]}},
                        else_7_else_1_else_conc_2_tmp_sg1}) , 6'b0};
                    mut_5_sg1_1 = acc_2_psp_sva;
                    div_mgc_div_2_b <= {1'b0 , acc_2_psp_sva , 5'b0};
                  end
                  2'b10 : begin
                    mut_6_sg1_1 = else_7_else_1_else_conc_2_tmp_sg1;
                    div_mgc_div_3_a <= {({{2{else_7_else_1_else_conc_2_tmp_sg1[7]}},
                        else_7_else_1_else_conc_2_tmp_sg1}) , 6'b0};
