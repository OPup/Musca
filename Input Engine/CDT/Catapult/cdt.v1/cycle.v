...
//  Generated date: Wed Apr 27 17:35:26 2016
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        S_IN_1_sg1_sva = S_IN_rsc_mgc_in_wire_d[9:1];
        V_IN_1_sg1_sva = V_IN_rsc_mgc_in_wire_d[9:1];
        slc_svs = readslicef_10_1_9((conv_u2u_9_10(H_IN_1_sva[9:1]) + 10'b1101010001));
        if ( slc_svs ) begin
          lor_sva_1 = ~ (readslicef_10_1_9((({1'b1 , (~ (H_IN_1_sva[8:0]))}) + 10'b1011)));
        end
        lor_lpi_dfm = lor_sva_1 | (~ slc_svs);
        if ( lor_lpi_dfm ) begin
          if_slc_svs = readslicef_10_1_9((conv_u2u_9_10(S_IN_1_sg1_sva) + 10'b1111011101));
          if ( if_slc_svs ) begin
          end
          else begin
            if_land_sva_1 = ~ (readslicef_10_1_9((conv_u2u_9_10(V_IN_1_sg1_sva) +
                10'b1111011101)));
          end
        end
