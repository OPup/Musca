...
//  Generated date: Wed Apr 27 17:59:25 2016
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        S_IN_1_sg1_sva = S_IN_rsc_mgc_in_wire_d[9:4];
        slc_svs = readslicef_9_1_8((conv_u2u_8_9(H_IN_1_sva[9:2]) + 9'b110101011));
        if ( slc_svs ) begin
          lor_sva_1 = ~ (readslicef_10_1_9((({1'b1 , (~ (H_IN_1_sva[8:0]))}) + 10'b110011)));
        end
        lor_lpi_dfm = lor_sva_1 | (~ slc_svs);
        if ( lor_lpi_dfm ) begin
          g_1_sva_1 = ~ (readslicef_7_1_6((conv_u2u_6_7(S_IN_1_sg1_sva) + 7'b1111011)));
        end
        G_OUT_rsc_mgc_out_stdreg_d <= signext_10_1(g_1_sva_1 & lor_lpi_dfm);
      end
    end
    g_1_sva_1 = 1'b0;
    lor_lpi_dfm = 1'b0;
