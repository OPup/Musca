...
//  Generated date: Thu Apr 28 18:38:33 2016
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        acc_cse_sg1_sva = readslicef_10_1_9((conv_u2u_9_10(V_IN_1_sva[9:1]) + 10'b1111111011));
        if ( acc_cse_sg1_sva ) begin
        end
        else begin
          land_sva_1 = ~ (readslicef_10_1_9((conv_u2u_9_10(S_IN_1_sva[9:1]) + 10'b1111011101)));
        end
        land_lpi_dfm = land_sva_1 & (~ acc_cse_sg1_sva);
        if ( land_lpi_dfm ) begin
        end
        else begin
          oelse_slc_svs = readslicef_11_1_10((conv_u2s_10_11(S_IN_1_sva) + 11'b11110111111));
          if ( oelse_slc_svs ) begin
          end
          else begin
            oelse_land_sva_1 = ~ (readslicef_10_1_9((conv_u2u_9_10(V_IN_1_sva[9:1])
                + 10'b1111110001)));
          end
        end
        lor_lpi_dfm = (oelse_land_sva_1 & (~ oelse_slc_svs)) | land_lpi_dfm;
        ...
        else if ( acc_cse_sg1_sva ) begin
        end
        else begin
          oelse_1_land_sva_1 = ~ (readslicef_10_1_9((conv_u2u_9_10(S_IN_1_sva[9:1])
              + 10'b1111100111)));
        end
        lor_1_lpi_dfm = (oelse_1_land_sva_1 & (~ acc_cse_sg1_sva)) | land_1_lpi_dfm;
        if ( lor_1_lpi_dfm ) begin
