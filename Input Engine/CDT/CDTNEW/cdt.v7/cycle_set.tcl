...
directive set /cdt/core/main/if:acc#2 CSTEPS_FROM {{.. == 1}}
directive set /cdt/core/main/oelse:acc CSTEPS_FROM {{.. == 1}}
directive set /cdt/core/main/oelse:acc#1 CSTEPS_FROM {{.. == 1}}
...
directive set /cdt/core/main/aif#5:acc CSTEPS_FROM {{.. == 1}}
directive set /cdt/core/main/oelse#1:acc CSTEPS_FROM {{.. == 1}}
