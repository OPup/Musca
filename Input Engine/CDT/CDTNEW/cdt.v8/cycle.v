...
//  Generated date: Fri Apr 29 16:51:22 2016
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        V_IN_1_sg1_sva = V_IN_rsc_mgc_in_wire_d[9:1];
        slc_svs = readslicef_10_1_9((conv_u2u_9_10(V_IN_1_sg1_sva) + 10'b1111111011));
        if ( slc_svs ) begin
        end
        else begin
        ...
        if ( land_lpi_dfm ) begin
          ...
          if ( oelse_slc_svs ) begin
            ...
            oelse_land_sva_1 = ~ (readslicef_10_1_9((conv_u2u_9_10(V_IN_1_sg1_sva)
                + 10'b1111110001)));
          end
        end
        ...
        if ( slc_1_svs ) begin
          ...
          if_1_slc_svs = readslicef_11_1_10((conv_u2s_10_11(H_IN_1_sva) + 11'b11100111101));
