...
directive set /cdt/core/main/if:io_read(S_IN:rsc.d) CSTEPS_FROM {{.. == 1}}
...
directive set /cdt/core/main/if:else:if:acc CSTEPS_FROM {{.. == 1}}
directive set /cdt/core/main/if:else:aif:acc CSTEPS_FROM {{.. == 1}}
