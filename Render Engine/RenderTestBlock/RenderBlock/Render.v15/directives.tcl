...
//  
//  Running on Windows 7 kjr115@EEWS104A-009 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./src/Render.cpp} -type C++
...
directive set -DESIGN_HIERARCHY Render
go compile
directive set /Render/core/main -UNROLL no
directive set /Render/core/main -PIPELINE_INIT_INTERVAL 1
go architect
go extract
