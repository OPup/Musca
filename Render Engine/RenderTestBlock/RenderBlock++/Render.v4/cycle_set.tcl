...
directive set /Render/core/main/io_write(v_out:rsc.d)#1 CSTEPS_FROM {{.. == 1}}

# Real operation constraints
directive set /Render/core/main/if:acc CSTEPS_FROM {{.. == 1}}
directive set /Render/core/main/if:acc#1 CSTEPS_FROM {{.. == 1}}
directive set /Render/core/main/if:acc#2 CSTEPS_FROM {{.. == 1}}
directive set /Render/core/main/aif#3:acc CSTEPS_FROM {{.. == 1}}
directive set /Render/core/main/acc#1 CSTEPS_FROM {{.. == 1}}
...
directive set /Render/core/main/aif#11:acc CSTEPS_FROM {{.. == 1}}
directive set /Render/core/main/if#2:acc CSTEPS_FROM {{.. == 1}}
directive set /Render/core/main/aif#15:acc CSTEPS_FROM {{.. == 1}}
