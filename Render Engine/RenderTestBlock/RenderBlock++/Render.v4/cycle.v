...
//  Generated date: Wed May 04 15:22:15 2016
// ----------------------------------------------------------------------
...
module Render_core (
  ...
  begin : core
    ...
    reg land_7_lpi_dfm;
    reg land_6_sva_1;
    reg C3443_12_dfmergedata_sg3_lpi_dfm_1;
    ...
    begin : mainExit
      forever begin : main
        ...
        acc_cse_sg1_sva = readslicef_11_1_10((conv_u2u_10_11(X_pix_1_sva[10:1]) +
            11'b11111110001));
        if ( acc_cse_sg1_sva ) begin
        end
        else begin
          land_2_sva_1 = ~ (readslicef_11_1_10((({1'b1 , (~ (X_pix_1_sva[10:1]))})
              + 11'b100111001)));
        end
        land_2_lpi_dfm = land_2_sva_1 & (~ acc_cse_sg1_sva);
        ...
        if ( acc_cse_sg1_sva ) begin
          ...
          land_8_sva_1 = ~ (readslicef_12_1_11((({1'b1 , (~ X_pix_1_sva)}) + 12'b10011100011)));
        end
        land_8_lpi_dfm = land_8_sva_1 & (~ acc_cse_sg1_sva);
        if ( land_8_lpi_dfm ) begin
          land_7_sva_1 = ~ (readslicef_11_1_10((conv_u2u_10_11(Y_pix_1_sva[10:1])
              + 11'b11100110001)));
        end
        land_7_lpi_dfm = land_7_sva_1 & land_8_lpi_dfm;
        if ( land_7_lpi_dfm ) begin
          land_6_sva_1 = ~ (readslicef_12_1_11((({1'b1 , (~ Y_pix_1_sva)}) + 12'b1111100011)));
        end
        C3443_12_dfmergedata_sg3_lpi_dfm_1 = (land_sva_1 & land_1_lpi_dfm) | (land_3_sva_1
            & land_4_lpi_dfm) | (land_6_sva_1 & land_7_lpi_dfm);
        v_out_rsc_mgc_out_stdreg_d <= {2'b11 , C3443_12_dfmergedata_sg3_lpi_dfm_1
            , 1'b1 , C3443_12_dfmergedata_sg3_lpi_dfm_1 , 3'b111 , ({{1{C3443_12_dfmergedata_sg3_lpi_dfm_1}},
            C3443_12_dfmergedata_sg3_lpi_dfm_1}) , 2'b11};
        begin : waitLoop1Exit
    ...
    C3443_12_dfmergedata_sg3_lpi_dfm_1 = 1'b0;
    land_6_sva_1 = 1'b0;
    land_7_lpi_dfm = 1'b0;
    land_7_sva_1 = 1'b0;
    land_8_lpi_dfm = 1'b0;
